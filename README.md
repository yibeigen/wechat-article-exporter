...
## 😭 开发者手记：一个独立开发者熬过来的数月攻坚

> **“如果能把某位大佬在全网所有平台写过的文章、发过的思考全部提取出来，喂给 AI 知识库，是不是就能 1:1 复刻出这位博主的「数字分身」？”**

这便是我开发 **BlogDistiller（博萃）** 的初心。然而，这个项目能够走到今天，背后的开发历程远比想象中艰难曲折得多：

- ⏳ **2026 年 7 月风控大地震**：各大平台收紧反爬策略，微信官方彻底切断了旧版抓取通道，市面上 90% 的文章导出工具一夜之间全军覆没！
- 💻 **数十个通宵的硬核逆向**：为了解决微信抓取难题，我一个人闭关硬核逆向数日，夜以继日地抓包、调试通信协议，最终独家打通了基于微信电脑端的通信链路，突破了接口封锁；
- 🧩 **多端协同的工程长征**：知乎和微博的动态鉴权门槛极高，我又写了浏览器插件做无感 Session 桥接；为了让小白能零门槛使用，我又做了 Windows 桌面客户端与 Web 在线工作台；为了让导出的 PDF 具备出版级排版，又调优了排版引擎与防抓去噪算法……

**这个项目没有团队，从前端 UI 设计、爬虫逆向、FastAPI 后端、文档转换到服务器运维，全是我利用无数个深夜与周末熬出来的。**
