...
<div align="center">
  ...
  **微信公众号 · 知乎 · 微博 · 新浪博客 · 简书 · CSDN · 掘金 · 博客园 · 51CTO · 9 大主流平台全量去噪与多格式导出**
...
> [!IMPORTANT]
> ### 📢 维护公告（2026-09-18）
> **📱 微信公众号 · 桌面客户端**：因微信官方近期调整了接口规则，桌面端暂时无法使用。我们正在全力寻找新的解决方案，**修复后会第一时间在交流群通知大家**，请先扫码进群耐心等待，感谢理解与支持！🙏
>
> **🌐 其他平台 · Web 在线工作台**：均可正常使用。但各平台会不定期更新页面与接口，使用中如遇解析失败或导出异常，请**加入上方交流群**或**添加作者微信 `peace-83`** 反馈问题，我们会尽快修复。
>
> 💡 进群方式：扫描下方「博萃·文章导出交流群」二维码；若二维码已过期，请关注公众号【艺杯羹】回复「进群」联系作者拉你入群。
...
graph TD
    ...
    Choose -->|CSDN / 掘金 / 博客园 / 51CTO / 新浪博客| MethodC["🌐 Web 在线工作台<br>免安装直接用 · 智能去噪 · 自定义署名"]
...
3. **启动成功界面展示**：
   - 双击后会弹出如下终端黑窗口，显示 `Uvicorn running on http://127.0.0.1:8000` 即代表**本地服务已完全就绪**（红框即本地访问地址，日常使用请保持此窗口开启，最小化即可）：
